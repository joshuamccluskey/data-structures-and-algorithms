...
const addTwo = (arr) => {
  ...
  // Ouput: arrSum[sum]
  // Arr : [];
  // For : arr[i] + 2; push sum to sumArr
  // Return: arrSum
...
const typeNum = (arr) => {
  // Solution code here...
  // Input: arr
  // Out: num[numbers only]
  // Var: .filter : conditional using .isNaN() or typeof num ;
  // return Var

  let numFilter = arr.filter(num => typeof num === 'number');
...
const containsAnd = (arr) => {
  // Solution code here...
  // Input: arr;
  // Output: andArr [strings containing 'and' 'panda', 'and']
  // Var: .filter : conditional 'and' using .includes('and')
  // Return: Var

  let filterAnd = arr.filter(str => str.includes('and'));
...
const oddValues = (arr) => {
  ...
  // Output: [odd nums]
  // Var: filter
  // Condition: num % 2 !== 0 ? true : false;
  // Return var

  let oddFilter = arr.filter(num => num % 2 !== 0 ? true : false);
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  // Logic: !forbiddenValues

  let verbodenStr = arr.filter(str => !forbiddenValues.includes(str));
