...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  // Input: arr, callback
  // Output: animalSort of sorted strings
  // strArr: []
  // push: pass argument  invoke callback
  // Return: strArr 
  let strArr = [];
  arr.forEach(str => {
    let strUpLower = callback(str);
    strArr.push(strUpLower);
  });
...
const alphabetizeBetter = (arr) => {
  // Solution code here...
  // Input: arr
  // Output: arr of sorted strings with capital and lower case
  // Use regular expressions charAt(0) to get first letter of each string
  // Use 
