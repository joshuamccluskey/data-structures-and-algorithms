...
const raisedToTheThird = (arr) => {
  // Solution code here Challenge 1
  // Results: = []
  // Arr: ForEach
  // power: = Math.pow ( num, power)
  // push: power to result
  // Return: Results
...
const addOne = (arr) => {
  // Solution code here Challenge 2
  // var : arr.map (num => num + 1);
  // return: var

  let addMap = arr.map(num => num + 1);
...
const addQuestion = (arr) => {
  // Solution code here Challenge 3
  // var : arr.map (string => string + "?");
  // return var

  let concantMap = arr.map(str => str + '?');
...
const forLoopTwoToThe = (arr) => {
  // Solution code here Challenge 4
  // input: arr
  // Outputs: 67, 111, 100, 101, 51, 48, 49
  // Results: []
  //  Mathpow(num, arr [i]));
  // return var
...
const forEachTwoToThe = (arr) => {
  ...
  // input: arr
  // Outputs:1, 16, 32; 0.5, 0.25, 0.125
  // Results: []
  // foreach: Mathpow(num, arr [i]));
  // return: results[]

  let results = [];

  arr.forEach(num => {
    let powerNum = Math.pow(2, num);
    results.push(powerNum);
...
const mapTwoToThe = (arr) => {
  ...
  // input: arr
  // Outputs:1, 16, 32; 0.5, 0.25, 0.125
  // PowerMap: arr Map Math.pow(2, num)
  // return PowerMap

  let powerMap = arr.map(num => Math.pow(2, num));
  return powerMap;
...
const charCode = (arr) => {
  ...
  // input: arr
  // Outputs: 67, 111, 100, 101, 51, 48, 49
  // Do the strMap with charCodeAt() don't pass the index arguement
  // return StrMap

  let strMap = arr.map(str => str.charCodeAt());
...
const evenOdd = (arr) => {
  // Solution code here..
  //input: arr of values
  //output: 'odd', 'even', 'even', 'even', 'odd', 'odd', 'even', 'odd', 'N/A'
  // Map: numMap arr. map num => Number
  // Use ternary conditional remainder operator === 0 is even : odd
  // Use conditional isNaN(num)
  // reuturn numMap

  let numMap = arr.map(num => {
...
const extractAbilities = (arr) => {
  // Solution code here...
  // input: arr
  // Output: Arr ['gluttony', 'cute charm', 'immunity']
  // Map function targeting only abilities
  // return the map

  let snorlaxMap = arr.map(element => element.ability.name);
...
const extractStats = (arr) => {
  // Solution code here...
  // input: arr
  // Output: Arr objects stats
  // Map function targeting only abilities
  // return the map

  let snorlaxStatsMap = arr.map(element => {
    let emptyObject = {};
    emptyObject.name = element.stat.name;
    emptyObject.total = element.effort + element.baseStat;

    return emptyObject;
  });

  return snorlaxStatsMap;
};
