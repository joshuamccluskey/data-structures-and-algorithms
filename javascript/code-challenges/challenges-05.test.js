...
const toLastNames = people => {
  ...
  //Oput arr of concanated names
  //Map the array and concantenate each element object
};
...
const reversedString = (str) => {
  // Solution code here...
  // Input : str
  // Output : str reverved For example: Code 301 = 103 edoC
  // Split characters into indviual elements be cautious space
  // For loop decrementing for loop Push each element into created array i = arr.legneth; i >= 0 ; i --:
  // Reduce to combine elements back together
