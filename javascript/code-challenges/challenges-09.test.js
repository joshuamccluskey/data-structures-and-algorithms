...
E.g. [4,2,7,5,9,2] -> 9
------------------------------------------------------------------------------------------------ */
const maxInArray = (arr) => arr.reduce((acc, value) => Math.max(acc, value));


// Input arr
// Output max value
// need to use reduce
// Math.max(...arr); But need reduce()
...
const checkValues = (obj, value) => Object.is(obj.class, value);
...
const updateNumbers = (obj) => Object.entries(obj).map( arr => `${arr[0]}: ${arr[1]}`);
