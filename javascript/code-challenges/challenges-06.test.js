...
const getNames = (arr) => arr.map(str => str.name.split('').reverse().join(''));
// Solution code here...
// Input: arr
// Output: String reversed each name
//split()
//reverse()
//join()
...
// Solution code here...
// Input: obj, year
// Output: Object  unaltered, Object YearBorn Added
...
const setStatusAsAuthor = (people) => people.map(el => el.isAuthor = true);
// Solution code here...
// input people arr
// Output: people.isAuthor = true
...
const append = (arr1, arr2) => arr2.forEach(num => arr1.push(num));
// Solution code here...
// Input: arr1, arr2
